...
$sql = "SELECT * FROM message WHERE receiver='$username' ORDER BY deadline DESC";
...
if(isset($_POST["s_inbox"])){
	$t=$_POST["s_inbox"];
	$sql = "SELECT * FROM message WHERE receiver='$username' and sender='$t' ORDER BY deadline DESC";
	$result = $conn->query($sql);
	$f=0;
}
...
if(isset($_POST["s_sm"])){
	$t=$_POST["s_sm"];
	$sql = "SELECT * FROM message WHERE sender='$username' and receiver='$t' ORDER BY deadline DESC";
	$result = $conn->query($sql);
	$f=1;
}
...
if(isset($_POST["sm"])){
	$sql = "SELECT * FROM message WHERE sender='$username' ORDER BY deadline DESC";
	$result = $conn->query($sql);
	$f=1;
}
...
<nav class="navbar navbar-inverse navbar-fixed-top" id="my-navbar">
	<div class="container">
		<div class="navber-header">
			...
			<a href="index.php" class="navbar-brand">Omahsom</a>
		</div>
...
<div class="text-center" style="padding:4%;background:#222;color:#fff;margin-top:20px;">
	<div class="row">
		...
		<div class="col-lg-3">
		<h3>About Us</h3>
			<p>Omahsom aims at providing students with an opportunity,
			to earn money while they are still studying and connect
			with potential clients who are looking to hire freelancers.</p>
			<p class="copy">Copyright &copy; 2023 Omahsom. All rights reserved.</p>
		</div>
		<div class="col-lg-3">
		<h3>Contact Us</h3>
			<p>07080541304, 08059018907</p>
			<p>chisomchioma90@gmail.com</p>
		</div>
		<div class="col-lg-3">
